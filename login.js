...
const firebaseConfig = {
    apiKey: "AIzaSyBf43GBxrxdb24NAc4ZFCT7nsr9VKZdecg",
    authDomain: "autotool-hh3d.firebaseapp.com",
    projectId: "autotool-hh3d",
    storageBucket: "autotool-hh3d.firebasestorage.app",
    messagingSenderId: "439845099762",
    appId: "1:439845099762:web:cde96cc0f94952b0c6586b",
    measurementId: "G-3PKJJSJX5R"
  };
  ...
  document.getElementById("login").addEventListener("click", async (e) => {
    ...
    try {
      ...
      // Gửi token về extension (qua window.opener nếu được mở từ popup)
      window.opener?.postMessage({ firebaseToken: token }, "*");
